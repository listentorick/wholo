...
async function bootstrap() {
  ...
  // NEXT_APP_DIR must point to the apps/driver directory.
  // Default resolves from dist/main.js → apps/driver-api/dist → apps/driver-api → apps → apps/driver.
  // Docker image sets NEXT_APP_DIR=/app/driver explicitly.
  const dir = process.env.NEXT_APP_DIR ?? join(__dirname, '..', '..', 'driver');
