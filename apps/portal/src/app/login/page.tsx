  ...
  return (
    <>
      <style>{`
        ...
        .wh-input::placeholder { color: #C4B5A8; }
        .wh-input:focus { border-bottom-color: #D97036; }
        .wh-input:disabled { opacity: 0.45; cursor: not-allowed; }
        ...
        .wh-btn:hover:not(:disabled) { background: #D97036; color: #fff; }
        .wh-btn:active:not(:disabled) { background: #C4622A; border-color: #C4622A; color: #fff; }
        .wh-btn:disabled { opacity: 0.55; cursor: not-allowed; }
      ...
      >
        <div style={{ width: '100%', maxWidth: '360px' }}>
          ...
          <div className="anim-1" style={{ marginBottom: '52px', textAlign: 'center' }}>
            ...
            >
              Order smarter. Grow together.
            </p>
            <div style={{ width: '28px', height: '1.5px', backgroundColor: '#D97036', margin: '0 auto' }} />
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate>
            ...
            <div className="anim-4">
              <button type="submit" className="wh-btn" disabled={isSubmitting}>
                {isSubmitting ? (
                  <>
